...
1. Open the terminal dashboard and show BTC spot, SVI health, max executable edge, and kill-switch state.
2. Compare DeepBook SVI with external bid, mid, and ask smiles.
