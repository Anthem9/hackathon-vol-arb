...
- Latest GitHub Actions `CI` on `main`: pass (`25648839447`) after committed Playwright smoke, Polymarket funding preflight, configurable BTC price source, small-capital gate runbook, and real testnet demo script updates.
